...
Retuning yields consistent improvements in $J_\lambda := J_P + \lambda J_C$, underscoring that $p$ influences not only reliability but also the optimal allocation of transmission attempts over a finite horizon.
